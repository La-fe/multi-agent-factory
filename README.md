...
│   │   ├── decompose.md       ← /decompose — V2 智能任务拆解（3 模式 + 8 阶段）
│   │   ├── decompose-eval.md  ← /decompose-eval — 拆解质量评估（12 维度）
│   │   ├── issue.md           ← /issue — Issue 分析
│   │   └── triage.md          ← /triage — Issue 分类
│   ├── skills/
│   │   └── task-decompose/
│   │       └── references/    ← 拆解方法论参考文件（按需加载）
│   │           ├── methodology.md
│   │           ├── complexity-guide.md
│   │           ├── wave-rules.md
│   │           └── issue-template.md
...
| Claude Code 命令                   | 用途                                           |
| -------------------------------- | -------------------------------------------- |
| `/decompose <PRD\|描述\|URL>`      | V2 智能拆解：3 模式 + Merge Contract + Wave 编排      |
| `/decompose-eval <拆解结果>`         | 12 维度质量评估 + 8 条 Veto 规则                      |
| `/reviewpr <PR#>`                | 审查指定 PR                                      |
| `/landpr <PR#>`                  | 合并指定 PR                                      |
